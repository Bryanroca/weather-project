  ...
  return (
    <section className="columna-izquierda" id='columna-izquierda'>
      ...
      <div className="columna-iquierda-contenedor" id="columna-iquierda-contenedor">
        <button For="btn-menu" onClick={boton_abrir} className="lugares" id="Lugares">Buscar el lugar</button>
      ...
      <div className='container-menu' id="container-menu">
        <div className='cont-menu'>
          <div className='container-x'>
            <i onClick={boton_cerrar} class="fa-solid fa-x"></i>
          ...
          <div className='buscador'>
            ...
            <button onClick={extraer_informacion} className='buscador-boton'>Buscar</button>
          </div>
          <nav>
            <li id="Londres">Londres</li>
            <li id="Barcelona">Barcelona</li>
            <li id="Miami">Miami</li>
          </nav>
        </div>
      </div>
